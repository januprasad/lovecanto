...
public class LoveMatch extends Activity {
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if ((nom1.length() > 0) && (nom2.length() > 0)) {
                            ...
                            if (Score > 0) {
                                obsrevation = getResources().getString(R.string.obs1);
                            }
                            if (Score > 4) {
                                obsrevation = getResources().getString(R.string.obs2);
                            }
                            if (Score > 10) {
                                obsrevation = getResources().getString(R.string.obs3);
                            }
                            if (Score > 20) {
                                obsrevation = getResources().getString(R.string.obs4);
                            }
                            if (Score > 40) {
                                obsrevation = getResources().getString(R.string.obs5);
                            }
                            if (Score == 51) {
                                obsrevation = getResources().getString(R.string.obs6);
                            }
                            if (Score > 51) {
                                obsrevation = getResources().getString(R.string.obs7);
                            }
                            if (Score == 69) {
                                obsrevation = getResources().getString(R.string.obs8);
                            }
                            if (Score > 69) {
                                obsrevation = getResources().getString(R.string.obs9);
                            }
                            if (Score > 80) {
                                obsrevation = getResources().getString(R.string.obs10);
                            }
                            if (Score > 90) {
                                obsrevation = getResources().getString(R.string.obs11);
                            }
...
//                            Intent intent = new Intent(LoveMatch.this, Result.class);
