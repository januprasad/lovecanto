 ...
 */
public class ImageApiCall extends AsyncTask<String, String, String> {
    ...
    public static final int VLOW = 3;
    ...
    public ImageApiCall(int type, Callback callback) {
...
//                "http://www.omdbapi.com/?t=terminator&y=&plot=short&r=json", "GET", params);
        ...
        if (networkType == HD)
            json = new CustomHTTPClient().makeHttpRequest(
                    "https://raw.githubusercontent.com/jenuprasad/myapp-api/master/images.json", "GET", params);
        else if (networkType == LOW)
            json = new CustomHTTPClient().makeHttpRequest(
                    "https://raw.githubusercontent.com/jenuprasad/myapp-api/master/images_low.json", "GET", params);
        else if (networkType == VLOW)
            json = new CustomHTTPClient().makeHttpRequest(
                    "https://raw.githubusercontent.com/jenuprasad/myapp-api/master/images_vlow.json", "GET", params);
